      ...
      <div className={styles.brand}>
            ...
            <div className={styles.team}>
                  ...
                  <div className={styles.card}>
                      <img src="/images/frontEnt4.png" alt=" desarrollador 4" />
                      <h4>Abel Tintilay</h4>
                      <span>Frontend Developer</span>
                  </div>

                  <div className={styles.card}>
                      <img src="/images/frontEnd1.png" alt=" desarrollador 1" />
                      <h4>Leo Messi</h4>
                      <span>UI Designer</span>
                  </div>

                  <div className={styles.card}>
                      <img src="/images/frontEnd2.webp" alt=" desarrollador 2" />
